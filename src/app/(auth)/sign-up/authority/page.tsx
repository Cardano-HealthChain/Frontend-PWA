        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-5xl h-full md:h-[600px] bg-background rounded-xl overflow-hidden">
            ...
            <div className="flex flex-col justify-center p-8 md:p-12">
                ...
                <p className="mt-4 text-lg text-muted-foreground">
                    Monitor population health, manage outbreaks, and issue targeted alerts.
                </p>

                <div className="mt-6 space-y-3 text-sm text-primary">
                    <p>• Community health analytics</p>
                    <p>• Geo-targeted alert system</p>
                    <p>• Outbreak monitoring</p>
                    <p>• Clinic verification & auditing anonymized data insights</p>
                    {/* <p className="mt-2">
                ...
                <Button
                    ...
                    onClick={() => router.push("/sign-up/authority/onboard")}
                >
