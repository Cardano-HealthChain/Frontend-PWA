...
import { ClinicInformationForm } from "./_components/ClinicInformationForm";
...
export default function ClinicStepperPage() {
  ...
  const handleNext = () => {
    if (currentStep < 5) {
      ...
      router.push("/sign-up/clinic/under-review");
    }
  };
