...
const facilityTypes = ["Hospital", "Clinic", "Pharmacy", "Laboratory", "Specialist Center"];
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <div className="grid gap-2">
        <Label htmlFor="facility-type">Clinic/Facility Type</Label>
        <Select>
          <SelectTrigger className="border-primary" id="facility-type">
            <SelectValue placeholder="Select Clinic/Facility Type" />
          </SelectTrigger>
      ...
      <div className="grid gap-2">
        ...
        <Input id="clinic-phone" type="tel" placeholder="Enter Phone Number" className="border-primary" />
      </div>

      <div className="grid gap-2 md:col-span-2">
        <Label htmlFor="address">Address</Label>
        <Input id="address" placeholder="Enter Clinic Address" className="border-primary" />
      </div>
      ...
      <p className="text-xs text-muted-foreground mt-4 md:col-span-2">
        This information will be verified by your local health authority.
      </p>
    </div>
  )
}