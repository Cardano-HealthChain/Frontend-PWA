...
export default function ClinicUnderReviewPage() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-5xl">
            ...
            <Card className="flex flex-col justify-center p-12 shadow-lg border-0">
                ...
                <Button variant="outline" className="mt-6 w-full max-w-xs" onClick={() => router.push("/dashboard")}>
            ...
            <div className="hidden md:flex items-center justify-center">
                <Image
                    src="/images/clinic-1.png" // Placeholder for the stylish image
